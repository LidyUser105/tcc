...
.footer {
  ...
  text-align: center;
    ...
    <a href="agendamento.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Agendamento</a>
        ...
        <section id="direita">
         ...
         <br><label for="crm"> CRM: </label>
          ...
          <tr><input type="checkbox" id="sexta" name = "sexta" value = "sexta" > Sexta - feira</button>
            ...
            <input class="w3-button w3-light-grey w3-padding-large w3-large" type="submit" name="batata" value="Submit">
